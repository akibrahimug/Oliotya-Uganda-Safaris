...
// Client-side schema for scalar form fields only (destinations managed as separate state)
export const customPackageClientSchema = z.object({
  name: z
    .string()
    .max(200, "Package name too long")
...
export type CustomPackageClientData = z.infer<typeof customPackageClientSchema>;
