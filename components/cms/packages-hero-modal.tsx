...
interface PackagesHeroModalProps {
  open: boolean;
  onClose: () => void;
...
export function PackagesHeroModal({
  open,
  onClose,
  onSave,
  initialData,
}: PackagesHeroModalProps) {
    ...
    <>
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent className="max-w-[95vw] lg:max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Edit Packages Page Hero</DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Explore curated safari experiences..."
              />
            </div>
