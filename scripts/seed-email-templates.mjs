...
const emailTemplates = [
  {
    ...
    introText: 'Thank you for booking with Oliotya Uganda Safaris! Your safari adventure is confirmed.',
...
The Oliotya Uganda Safaris Team`,
    footerText: 'Oliotya Uganda Safaris - Unforgettable Safari Experiences',
  ...
  },
  {
    ...
    footerText: 'This notification was sent from Oliotya Uganda Safaris booking system.',
    contactEmail: 'Info@oliotyaugandasafaris.com',
    primaryColor: '#059669',
    accentColor: '#fbbf24',
    active: true,
  },
  {
    ...
    companyName: 'Oliotya Uganda Safaris',
    heading: 'Thank You for Contacting Oliotya Uganda Safaris',
    greeting: 'Dear {name},',
...
At Oliotya Uganda Safaris, we're passionate about creating unforgettable safari experiences. Whether you're dreaming of gorilla trekking in Bwindi, witnessing the Big Five, or exploring Uganda's pristine landscapes, we're here to make it happen.`,
...
The Oliotya Uganda Safaris Team`,
  ...
  },
  {
    ...
    footerText: 'This notification was sent from Oliotya Uganda Safaris contact form.',
    contactEmail: 'Info@oliotyaugandasafaris.com',
    primaryColor: '#059669',
    accentColor: '#f59e0b',
    active: true,
  },
  {
    ...
    introText: 'Thank you for choosing Oliotya Uganda Safaris to create your dream safari experience! We\'ve received your custom package request for "{name}".',
    nextStepsTitle: 'What Happens Next?',
...
The Oliotya Uganda Safaris Team`,
  ...
  },
  {
    ...
    footerText: 'This notification was sent from Oliotya Uganda Safaris custom package builder.',
    contactEmail: 'Info@oliotyaugandasafaris.com',
    primaryColor: '#059669',
    accentColor: '#8b5cf6',
    active: true,
