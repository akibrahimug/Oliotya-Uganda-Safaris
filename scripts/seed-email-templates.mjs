...
const emailTemplates = [
  {
    ...
    introText: 'Thank you for booking with Oliotya Safaris! Your safari adventure is confirmed.',
...
The Oliotya Safaris Team`,
    footerText: 'Oliotya Safaris - Unforgettable Safari Experiences',
  ...
  },
  {
    ...
    footerText: 'This notification was sent from Oliotya Safaris booking system.',
    contactEmail: 'info@oliotyasafaris.com',
    primaryColor: '#059669',
    accentColor: '#fbbf24',
    active: true,
  },
  {
    ...
    companyName: 'Oliotya Safaris',
    heading: 'Thank You for Contacting Oliotya Safaris',
    greeting: 'Dear {name},',
...
At Oliotya Safaris, we're passionate about creating unforgettable safari experiences. Whether you're dreaming of gorilla trekking in Bwindi, witnessing the Big Five, or exploring Uganda's pristine landscapes, we're here to make it happen.`,
...
The Oliotya Safaris Team`,
  ...
  },
  {
    ...
    footerText: 'This notification was sent from Oliotya Safaris contact form.',
    contactEmail: 'info@oliotyasafaris.com',
    primaryColor: '#059669',
    accentColor: '#f59e0b',
    active: true,
  },
  {
    ...
    introText: 'Thank you for choosing Oliotya Safaris to create your dream safari experience! We\'ve received your custom package request for "{name}".',
    nextStepsTitle: 'What Happens Next?',
...
The Oliotya Safaris Team`,
  ...
  },
  {
    ...
    footerText: 'This notification was sent from Oliotya Safaris custom package builder.',
    contactEmail: 'info@oliotyasafaris.com',
    primaryColor: '#059669',
    accentColor: '#8b5cf6',
    active: true,
