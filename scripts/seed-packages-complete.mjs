...
// Complete packages with full data
const allPackages = [
  {
    id: 1,
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        description: "Game drive in Ishasha to spot tree-climbing lions.",
      },
      {
        day: 17,
...
async function seedPackages() {
  ...
  for (const pkg of allPackages) {
    ...
    try {
      // Check if package already exists by slug
      ...
      const packageData = {
        ...
        shortDesc: pkg.description.substring(0, 200) + "...", // Create short description
        image: pkg.image,
        images: pkg.images || [],
        ...
        active: pkg.active !== false, // Default to true unless explicitly false
        displayOrder: pkg.id, // Use ID as display order
      };
  ...
  console.log("\n" + "=".repeat(70));
  console.log("Package Seeding Summary");
