...
async function main() {
  ...
  const hero = await prisma.bookingConfirmationHero.upsert({
    ...
    create: {
      ...
      description: 'Thank you for choosing Oliotya Uganda Safaris. Your booking request has been successfully received, and we\'re excited to help you create unforgettable memories!',
